	...
	<div id="services">
		...
		<div class="top-section">
			<div class="container">
				...
				<div class="sixteen columns" data-scrollreveal="enter bottom and move 250px over 3s">
					<div class="sections-link-pages"><div class="cl-effect-11"><a class="scroll" href="#pric-scroll" data-hover="OUR SERVICES">OUR SERVICES</a></div></div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="one-third column" data-scrollreveal="enter bottom and move 250px over 1.5s">
						<div class="plan-single">
							...
							<div class="sections-link-pages">
								<div class="cl-effect-11"><a href="../contact.html" data-hover="Create Yours">Create Yours</a>
								</div>
							</div>
						</div>
					</div>
					<div class="one-third column" data-scrollreveal="enter bottom and move 250px over 1.5s">
						<div class="plan-single">
							...
							<div class="sections-link-pages"><div class="cl-effect-11"><a href="../contact.html" data-hover="Order Now">Order Now</a></div></div>
						</div>
					</div>
					<div class="one-third column" data-scrollreveal="enter bottom and move 250px over 1.5s">
						<div class="plan-single">
							...
							<div class="sections-link-pages"><div class="cl-effect-11"><a href="../contact.html" data-hover="Contact Us">Contact Us</a></div></div>
						</div>
					</div>
				</div>
				<div class="row">
